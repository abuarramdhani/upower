					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="<?php echo base_url()."index.php/MyController/catalogpage" ?>" >Catalog</a></li>
                                <li role="presentation"><a href="<?php echo base_url()."index.php/MyController/emailpage" ?>">Book Service Online</a></li>
								<li role="presentation"><a href="<?php echo base_url()."index.php/MyController/contactpage" ?>" class="active">Contact</a></li>						
							</ul>
						</div>
					</div>						
				</div>
        ...
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <?php echo form_open_multipart('MyController/email'); ?>
                        ...
                        <div class="text-center"><input type="submit" name="submit" class="btn btn-primary btn-lg" required="required">Kirim Pesan</button></div>
                    <?php echo form_close();?>                    
                </div>
            </div><!--/.row-->
        </div><!--/.container-->
