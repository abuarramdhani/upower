	...
	<section id="portfolio">	
        <div class="container">
            ...
            <ul class="portfolio-filter text-center">
                ...
                <li><a class="btn btn-default" href="<?php echo base_url()."index.php/MyController/gensetpage" ?>">Genset</a></li>
                <li><a class="btn btn-default active" href="<?php echo base_url()."index.php/MyController/compage" ?>" >Compressor</a></li>
            </ul><!--/#portfolio-filter-->
		</div>
                ...
                <?php foreach ($data as $x) { ?>
                    ...
                    <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url().'/uploads/compressor/'.$x['img_com']; ?>">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#"><?= $x['nama_com'] ?></a></h3>
                                    <p><?= $x['des_com'] ?></p>
                                    <a class="preview" href="<?php echo base_url().'/uploads/compressor/'.$x['img_com']; ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                </div> 
                            </div>
                        </div>
