	...
	<section id="portfolio">	
        <div class="container">
            ...
            <ul class="portfolio-filter text-center">
                <li><a class="btn btn-default" href="<?php echo base_url()."index.php/c_user/catalogpage" ?>">Forklift</a></li>
                <li><a class="btn btn-default" href="<?php echo base_url()."index.php/c_user/gensetpage" ?>">Genset</a></li>
                <li><a class="btn btn-default active" href="<?php echo base_url()."index.php/c_user/compage" ?>" >Compressor</a></li>
            </ul><!--/#portfolio-filter-->
		</div>
