...
<html lang="en">
  <head>
    ...
    <title>Edit Compressor || Admin</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Edit Compressor</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-files-o"></i>Edit Compressor</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="<?php echo base_url()."index.php/c_admin/doeditcom" ?>" enctype="multipart/form-data">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">ID Compressor <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="id_com" type="text" value="<?php echo $id_com; ?>" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Nama Compressor <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" type="text" name="nama_com" value="<?php echo $nama_com; ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Merk Compressor <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" type="text" name="merk_com" value="<?php echo $merk_com; ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Model Compressor </label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="model_com" type="text" value="<?php echo $model_com; ?>" required/>
                                          </div>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Berat Compressor </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="berat_com" value="<?php echo $berat_com; ?>" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Kondisi Compressor </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="ccomment" name="kondisi_com" value="<?php echo $kondisi_com; ?>" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Harga Compressor </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="harga_com" value="<?php echo $harga_com; ?>" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Deskripsi Compressor <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="ccomment" name="des_com" value="<?php echo $des_com; ?>" required></textarea>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Foto Compressor </label>
                                          <div class="col-lg-10">
                                      <input class="form-control " id="cname" type="file" name="img_com" size="20" required></input
                                    ></div>
                                      </div>
