...
<html lang="en">
  <head>
    ...
    <title>Tambah Forklift || Admin</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Tambah Forklift</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-files-o"></i>Tambah Forklift</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="<?php echo base_url()."index.php/c_admin/uploadforklift" ?>" enctype="multipart/form-data">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">ID Forklift <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="id_forklift" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Nama Forklift <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" type="text" name="nama_forklift" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Merk Forklift <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" type="text" name="merk_forklift" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Tipe Forklift</label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="tipe_forklift" type="text" required/>
                                          </div>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Tahun Forklift </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="tahun_forklift" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Berat Forklift </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="ccomment" name="berat_forklift" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Max Forklift </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="max_forklift" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Kondisi Forklift </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="kondisi_forklift" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Harga Forklift </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cname" name="harga_forklift" required></input>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Deskripsi Forklift <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="ccomment" name="des_forklift" required></textarea>
                                          </div>
                                      </div>
                                      <div class="form-group ">
