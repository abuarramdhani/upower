...
<html lang="en">
  <head>
    ...
    <title>Data Compressor || Admin</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i> Data Compressor</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-table"></i>Table</li>
						<li><i class="fa fa-th-list"></i>Data Compressor</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                            ...
                            <table class="table">
                              <thead>
                                <tr>
                                  <th></th>
                                  <th>#</th>
                                  <th>Nama Compressor</th>
                                  <th>Merk Compressor</th>
                                  <th>Model Compressor</th>
                                  <th>Berat Compressor</th>
                                  <th>Kondisi Compressor</th>
                                  <th>Harga Compressor</th>
                                  <th>Deskripsi Compressor</th>
                                  <th>Gambar Compressor</th>
                                  <th></th>
                                </tr>
                              </thead>
                              <tbody>
                              <form method="post" action="<?php echo base_url().'index.php/c_admin/delcom'?>">

                                <?php foreach ($data as $x) { ?>

                                <tr>
                                    <td><input type="checkbox" value="<?= $x['id_com'] ?>" name="item[]"></td>
                                    <td><?= $x['id_com'] ?></td>
                                    <td><?= $x['nama_com'] ?></td>
                                    <td><?= $x['merk_com'] ?></td>
                                    <td><?= $x['model_com'] ?></td>
                                    ...
                                    <td><?= $x['harga_com'] ?></td>
                                    <td><?= $x['des_com'] ?></td>
                                    <td style="width:10px, height:10px;"><img src="<?php echo base_url().'/uploads/compressor/'.$x['img_com']; ?>"></td>

                                    <td align="center">
                                        <a href="<?php echo base_url()."index.php/c_admin/editcom/".$x['id_com'];?>">Edit</a>
                                    </td>
                                </tr>        
